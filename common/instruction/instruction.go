...
const (
	...
	INST_ADD_MEM_REG           Type = 0x1b
	INST_ADD_SP_IMM            Type = 0x1c
	INST_SUB_SP_IMM            Type = 0x1d
	INST_ADD_IP_IMM            Type = 0x1e
	INST_SUB_IP_IMM            Type = 0x1f
	INST_MOV_REG_REG           Type = 0x20
	INST_MOV_REG_IMM           Type = 0x21
	INST_MOV_MEM_REG           Type = 0x22
	INST_MOV_REG_MEM           Type = 0x23
	INST_MOV_MEM_REG_OFFSET    Type = 0x24
	INST_MOV_REG_MEM_OFFSET    Type = 0x25
	INST_MOV_REG_SP            Type = 0x26
	INST_MOV_SP_REG            Type = 0x27
	INST_MOV_REG_SP_OFFSET     Type = 0x28
	INST_MOV_SP_REG_OFFSET     Type = 0x29
	INST_MOV_REG_SP_OFFSET_REG Type = 0x2a
	INST_MOV_SP_REG_OFFSET_REG Type = 0x2b
	INST_XOR_REG_REG           Type = 0x2c
	INST_XOR_REG_IMM           Type = 0x2d
	INST_AND_REG_REG           Type = 0x2e
	INST_AND_REG_IMM           Type = 0x2f
	INST_OR_REG_REG            Type = 0x30
	INST_OR_REG_IMM            Type = 0x31
	INST_NOT_REG               Type = 0x32
	INST_SHL_REG               Type = 0x33
	INST_SHR_REG               Type = 0x34
	INST_ROL_REG               Type = 0x35
	INST_ROR_REG               Type = 0x36
	INST_CLC_IMPL              Type = 0x37
	INST_PUSH_IP               Type = 0x38
	INST_POP_IP                Type = 0x39
	INST_PUSH_SP               Type = 0x3a
	INST_POP_SP                Type = 0x3b
	INST_PUSH_REG              Type = 0x3c
	INST_PUSH_IMM              Type = 0x3d
	INST_POP_REG               Type = 0x3e
	INST_CALL_IMPL             Type = 0x3f
	INST_RET_IMPL              Type = 0x40
)
