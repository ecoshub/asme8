...
var (
	_MNEMONIC_TO_OPCODE = map[string]map[uint8]uint8{
		...
		INST_MNEMONICS_JMP: {
			// jmp 0x5500
			ADDR_MODE_IMPL_IMM16: INST_JMP_IMM16,
			// jmp ip
			ADDR_MODE_IMPL_REG16: INST_JMP_REG16,
		},
		INST_MNEMONICS_JS: {
			// js 0x6000
			ADDR_MODE_IMPL_IMM16: INST_JS_IMM16,
		},
		INST_MNEMONICS_JNS: {
			// jns 0x6000
			ADDR_MODE_IMPL_IMM16: INST_JNS_IMM16,
		},
		INST_MNEMONICS_JZ: {
			// jz 0x6000
			ADDR_MODE_IMPL_IMM16: INST_JZ_IMM16,
		},
		INST_MNEMONICS_JNZ: {
			// jnz 0x6000
			ADDR_MODE_IMPL_IMM16: INST_JNZ_IMM16,
		},
		INST_MNEMONICS_JC: {
			// jc 0x6000
			ADDR_MODE_IMPL_IMM16: INST_JC_IMM16,
		},
		INST_MNEMONICS_JNC: {
			// jc 0x6000
			ADDR_MODE_IMPL_IMM16: INST_JNC_IMM16,
		},
		INST_MNEMONICS_PUSH: {
			// push a
