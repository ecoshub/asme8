...
var (
	CONTROL_SIGNALS map[instruction.Type]map[step][]uint64 = map[instruction.Type]map[step][]uint64{
		...
		instruction.INST_JZ_IMPL_IMM16:  GENERIC_CONDITIONAL_JMP_AND_NOT_JMP,
		instruction.INST_JNZ_IMPL_IMM16: GENERIC_CONDITIONAL_JMP_AND_NOT_JMP,
		instruction.INST_JS_IMPL_IMM16:  GENERIC_CONDITIONAL_JMP_AND_NOT_JMP,
		instruction.INST_JNS_IMPL_IMM16: GENERIC_CONDITIONAL_JMP_AND_NOT_JMP,
		instruction.INST_JC_IMPL_IMM16:  GENERIC_CONDITIONAL_JMP_AND_NOT_JMP,
		instruction.INST_JNC_IMPL_IMM16: GENERIC_CONDITIONAL_JMP_AND_NOT_JMP,
	}
)
