...
var (
	...
	IRQ_MICRO_INSTRUCTIONS = map[step][]uint64{
		...
		// jump to vector, clear IRQ line, clear interrupt enable
		3: {MI_VEC_1_OUT, MI_PC_IN_ADDR, MI_CL_IE, MI_CL_IRQ, MI_STEP_CLR},
	}
)
...
var (
	CONTROL_SIGNALS map[instruction.Type]map[step][]uint64 = map[instruction.Type]map[step][]uint64{
		...
		instruction.INST_JMP_IMPL_IMM16: {
			0: MI_CMD_FETCH_INST,
			1: {MI_BRIDGE_ENABLE, MI_PC_OUT_ADDR, MI_IO_READ, MI_MAR_L_IN, MI_PC_INC, MI_STEP_INC},
			2: {MI_BRIDGE_ENABLE, MI_PC_OUT_ADDR, MI_IO_READ, MI_MAR_H_IN, MI_PC_INC, MI_STEP_INC},
			3: {MI_MAR_OUT_ADDR, MI_PC_IN_ADDR, MI_STEP_CLR},
		...
		instruction.INST_JZ_IMPL_IMM16:  GENERIC_CONDITIONAL_NOT_JMP,
		instruction.INST_JNZ_IMPL_IMM16: GENERIC_CONDITIONAL_NOT_JMP,
		instruction.INST_JS_IMPL_IMM16:  GENERIC_CONDITIONAL_NOT_JMP,
		instruction.INST_JNS_IMPL_IMM16: GENERIC_CONDITIONAL_NOT_JMP,
		instruction.INST_JC_IMPL_IMM16:  GENERIC_CONDITIONAL_NOT_JMP,
		instruction.INST_JNC_IMPL_IMM16: GENERIC_CONDITIONAL_NOT_JMP,
