...
var (
	...
	IRQ_MICRO_INSTRUCTIONS = map[step][]uint64{
		...
		3: {MI_BRIDGE_ENABLE, MI_VEC_0_LOW_OUT, MI_IO_READ, MI_MAR_L_IN, MI_STEP_INC},
		4: {MI_BRIDGE_ENABLE, MI_VEC_0_HIGH_OUT, MI_IO_READ, MI_MAR_H_IN, MI_STEP_INC},
...
var (
	CONTROL_SIGNALS map[instruction.Type]map[step][]uint64 = map[instruction.Type]map[step][]uint64{
		...
		instruction.INST_MOV_REG16_REG16: {
			0: MI_CMD_FETCH_INST,
			1: MI_CMD_FETCH_OPERAND,
			2: {MI_BRIDGE_ENABLE, MI_OP_2_LOW_OUT, MI_OP_1_LOW_IN, MI_STEP_INC},
			3: {MI_BRIDGE_ENABLE, MI_OP_2_HIGH_OUT, MI_OP_1_HIGH_IN, MI_STEP_CLR},
		},
		// mov a, [bp]
