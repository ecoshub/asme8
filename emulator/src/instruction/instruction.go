...
const (
	...
	INST_XOR_REG_IMM Type = 0x51
	INST_AND_RR      Type = 0x52
	INST_AND_REG_IMM Type = 0x53
	INST_OR_RR       Type = 0x54
	INST_OR_REG_IMM  Type = 0x55
	INST_NOT_REG     Type = 0x56

	// Shift operations
	INST_SHL_REG Type = 0x57
	INST_SHR_REG Type = 0x58
	INST_ROL_REG Type = 0x59
	INST_ROR_REG Type = 0x5a
	_            Type = 0x5b
	_            Type = 0x5c
