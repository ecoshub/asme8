...
var (
	control map[instruction.Type]map[step]uint64 = map[instruction.Type]map[step]uint64{
		...
		instruction.INTS_MOV_REG_REG: {
			0: MI_CMD_FETCH_INST,    // fetch next instruction
			1: MI_CMD_FETCH_OPERAND, // load operation register
			2: MI_REG_OPERAND_2_OUT_Y | MI_REG_OPERAND_1_IN | MI_STEP_CLR,
		},
		...
		instruction.INST_MOV_REG_MEM: {
			...
			2: MI_PC_OUT | MI_IO_READ | MI_MAR_L_IN | MI_PC_INC | MI_STEP_INC,
			3: MI_PC_OUT | MI_IO_READ | MI_MAR_H_IN | MI_PC_INC | MI_STEP_INC,
			4: MI_REG_OPERAND_1_OUT_Y | MI_BRIDGE_ENABLE | MI_BRIDGE_DIR_OUT | MI_MAR_OUT | MI_IO_WRITE | MI_STEP_CLR,
		},
		instruction.INST_MOV_REG_MEM_OFFSET: {
			0: MI_CMD_FETCH_INST,    // fetch next instruction
			1: MI_CMD_FETCH_OPERAND, // load operation register
			2: MI_PC_OUT | MI_IO_READ | MI_REG_OPERAND_1_OUT_X | MI_BRIDGE_ENABLE | MI_ALU_ENABLE | MI_ALU_ADD | MI_ALU_STORE | MI_STEP_INC,
			3: MI_ALU_OUT | MI_MAR_L_IN | MI_PC_INC | MI_STEP_INC,
			4: MI_PC_OUT | MI_IO_READ | MI_BRIDGE_ENABLE | MI_ALU_ENABLE | MI_ALU_ADC | MI_ALU_STORE | MI_STEP_INC,
			5: MI_ALU_OUT | MI_MAR_H_IN | MI_PC_INC | MI_STEP_INC,
			6: MI_MAR_OUT | MI_IO_READ | MI_REG_OPERAND_2_IN | MI_STEP_CLR,
		},
		instruction.INST_ADD_INM: {
			0: MI_CMD_FETCH_INST,    // fetch next instruction
			1: MI_CMD_FETCH_OPERAND, // load operation register
			2: MI_PC_OUT | MI_IO_READ | MI_BRIDGE_ENABLE | MI_REG_OPERAND_1_OUT_X | MI_ALU_ENABLE | MI_ALU_ADD | MI_ALU_STORE | MI_PC_INC | MI_STEP_INC,
		...
		instruction.INST_SUB_RR: {
			0: MI_CMD_FETCH_INST,    // fetch next instruction
			1: MI_CMD_FETCH_OPERAND, // load operation register
			2: MI_REG_OPERAND_1_OUT_X | MI_REG_OPERAND_2_OUT_Y | MI_ALU_ENABLE | MI_ALU_SUB | MI_REG_OPERAND_1_IN | MI_STEP_CLR,
		},
		...
		instruction.INST_CMP_INM: {
			0: MI_CMD_FETCH_INST,    // fetch next instruction
			1: MI_CMD_FETCH_OPERAND, // load operation register
			2: MI_PC_OUT | MI_IO_READ | MI_BRIDGE_ENABLE | MI_REG_OPERAND_1_OUT_X | MI_ALU_ENABLE | MI_ALU_CMP | MI_PC_INC | MI_STEP_CLR,
		},
